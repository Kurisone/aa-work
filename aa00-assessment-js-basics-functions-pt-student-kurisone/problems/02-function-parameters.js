...
// Your code here 
function recipeIngredients(str1, str2, str3){
  let ing1 = str1
  let ing2 = str2
  let ing3 = str3
  return "Recipe List: " + ing1 + ", " + ing2 + ", and " + ing3 + "."
}
...
console.log(recipeIngredients('Broccoli', 'Beef', 'Taiwan'))
...
function isInRange(lowNum, highNum, testNum){
  if (testNum >= lowNum && testNum <= highNum){
    return true
  }return false
}
