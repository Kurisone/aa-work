...
describe("04 - reverseWord", () => {
  ...
  describe("should return the input string but reversed by using String.prototype.split and Array.prototype.join methods", () => {
    ...
    it("should use the String.prototype.split method", () => {
      let numCallsBefore = splitSpy.__spy.calls ? splitSpy.__spy.calls.length : 0;
      reverseWord("ten");
      let numCallsAfter = splitSpy.__spy.calls ? splitSpy.__spy.calls.length : 0;
    ...
    it("should use the Array.prototype.reverse method", () => {
      let numCallsBefore = reverseSpy.__spy.calls ? reverseSpy.__spy.calls.length : 0;
      reverseWord("ten");
      let numCallsAfter = reverseSpy.__spy.calls ? reverseSpy.__spy.calls.length : 0;
      if (numCallsAfter <= numCallsBefore) {
